  ...
  research: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Current research questions",
        full: true,
        addLabel: "Add research question",
        itemType: "textarea",
      },
      {
        type: "list",
        key: "methods",
        label: "Methods and approaches",
        full: true,
        addLabel: "Add method",
        itemType: "text",
      },
  ...
  experience: {
    ...
    fields: [
      ...
      },
      {
        ...
        full: true,
        addLabel: "Add professional role",
        itemType: "object",
        fields: [
          { type: "text", key: "role", label: "Role", full: true },
          { type: "text", key: "institution", label: "Institution" },
      ...
      {
        type: "list",
        key: "conference_coordination",
        label: "Conference coordination",
        full: true,
        addLabel: "Add conference role",
        itemType: "object",
        fields: [
          { type: "text", key: "role", label: "Role" },
          { type: "text", key: "event", label: "Event" },
          { type: "text", key: "institution", label: "Institution", full: true },
          { type: "text", key: "dates", label: "Dates" },
          {
            type: "list",
            key: "highlights",
      ...
      {
        type: "list",
        key: "journal_referee_services",
        label: "Journal referee services",
        full: true,
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "textarea", key: "details", label: "Details", full: true },
        ],
      },
      {
        type: "list",
        ...
        itemType: "object",
        fields: [
          { type: "text", key: "name", label: "Language" },
          { type: "text", key: "level", label: "Level" },
        ],
      },
    ],
  },
